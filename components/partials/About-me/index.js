            ...
            <div className="row">
               <div className="col-12 col-md-7 d-flex flex-column justify-content-center">
                  ...
                  <div className="text-content">
                     ...
                     <p >In the meantime, I loved tinkering with big loads of data and improving the esthetics of diverse user interfaces. That's what pushed me to learn about product ownership and management. Before becoming a product manager, I started as a PO working for a Forbes 30 under 30 fintech startup that raised 1.5M dollars. I've since become obsessed with customers and never stopped analyzing their behaviors.</p><br/>
